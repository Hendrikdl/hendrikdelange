...
function About() {
  return (
    <Container style={{ padding: '40px 20px' }}>
      ...
      <Row className="justify-content-center">
        <Col md={10} lg={8}>
          <h3 style={{ color: '#007bff', marginTop: '30px' }}>Professional Experience</h3>
          <p>
          ...
          <h3 style={{ color: '#007bff', marginTop: '30px' }}>Career Journey</h3>
          <p>
          ...
          <h3 style={{ color: '#007bff', marginTop: '30px' }}>Education & Qualifications</h3>
          <p>
          ...
          <h3 style={{ color: '#007bff', marginTop: '30px' }}>My Approach</h3>
          <p>
